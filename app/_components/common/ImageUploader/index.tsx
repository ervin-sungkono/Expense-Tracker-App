  ...
  return (
    <div className="w-full flex flex-col gap-2">
      ...
      <div
        {...getRootProps({
          className:
            'relative dropzone cursor-pointer border focus:border-sky-blue border-deep-blue dark:border-ocean-blue/60 px-3 md:px-4 py-2 md:py-2.5 rounded-md',
        })}
      >
        ...
        {previewImage && (
          <button
            type="button"
            className="absolute cursor-pointer p-2 bg-basic-gradient rounded-bl-lg right-0 top-0 text-white"
