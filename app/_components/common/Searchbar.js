...
export default function SearchBar({ ref, placeholder, maxLength, onSearch }) {
    ...
    return(
        <div className="relative w-full flex flex-col gap-1">
            ...
            />
            <div onClick={handleSearch} className="cursor-pointer absolute right-1 top-1/2 -translate-y-1/2 p-2 rounded-full active:bg-neutral-200/30 dark:active:bg-neutral-700/30 transition-colors duration-150 ease-in-out">
                <SearchIcon size={18}/>
            </div>
        </div>
    )
