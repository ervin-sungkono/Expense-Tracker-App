  ...
  return (
    <div className="relative w-full flex flex-col gap-1">
      ...
      <div
        ...
        className="cursor-pointer absolute right-1 top-1/2 -translate-y-1/2 p-2 rounded-full active:bg-neutral-200/30 dark:active:bg-light/10 transition-colors duration-150 ease-in-out"
      >
        <SearchIcon size={18} />
      </div>
    </div>
