export default function LoadingOverlay() {
  return (
    <div className="fixed w-full h-full px-4 py-8 top-0 left-0 flex justify-center items-center z-[10000] overflow-hidden">
      <div
        className={`relative w-full h-full max-w-3xl mx-auto flex flex-col gap-4 justify-center items-center z-50`}
      >
      ...
      <div
        className={`pointer-events-none overlay absolute top-0 left-0 backdrop-blur-xl bg-neutral-700/60 w-full h-full`}
      ></div>
    </div>
  );
}
