    ...
    return(
        ...
        >
            <div className="flex flex-col grow">
                ...
                <p className="text-sm md:text-base text-dark/80 dark:text-white/80 grow">This app is an expense tracker for tracking your expense. It is built for offline support with no remote database, meaning that none of your data here is stored outside the application.</p>
