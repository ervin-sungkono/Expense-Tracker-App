...
function ListItem({ title, description, control, onClick, disabled }) {
    return(
        <div onClick={onClick} className={`${disabled ? 'pointer-events-none' : ''} cursor-pointer not-last:border-b not-last:border-b-white/20 w-full flex px-4 py-2 active:bg-neutral-300/30 dark:active:bg-neutral-800/30 transition-colors duration-150 ease-in-out`}>
