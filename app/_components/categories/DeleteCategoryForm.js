    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-dark/80 dark:text-white/80 text-sm md:text-base">
          1. <b>Merge:</b> Move all transactions, budgets and sub categories to another category
          before deleting
        </p>
        <p className="text-dark/80 dark:text-white/80 text-sm md:text-base">
          2. <b>Delete:</b> Delete all transactions, budgets and sub categories along with this
          category
        </p>
      </div>
      ...
      <Dialog show={showMerge} hideFn={() => setShowMerge(false)}>
        <MergeCategoryForm categoryId={categoryId} onMergeCategory={handleMergeCategory} />
      </Dialog>
    </div>
  );
}
