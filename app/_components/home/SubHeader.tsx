        ...
        return (
            <div className="w-full flex flex-col gap-0.5 mb-3 animate-pulse">
                <div className="flex items-center gap-2.5">
                    <p className="text-lg font-semibold text-transparent bg-neutral-300 dark:bg-neutral-800 rounded-full">{title}</p>
                    {(link || onClick) && 
                ...
                { description && <p className="block text-xs md:text-sm text-transparent bg-neutral-300 dark:bg-neutral-800 rounded-full">{description}</p>}
            </div>
        )
    } else {
        return(
