...
export default function TransactionReport() {
  ...
  useEffect(() => {
    if (yearMap) {
      ...
      const newWeeks = yearList.reduce((acc, year) => {
      ...
      component: (
        <TransactionGraph
          ...
          historyTransactionData={
            weekMap && weekMap[`${getPreviousWeekKey(selectedYear, selectedWeek)}`]
          }
    ...
    },
    {
      ...
      component: (
        <TransactionGraph
          ...
          historyTransactionData={
            monthMap && monthMap[`${getPreviousMonthKey(selectedYear, selectedMonth)}`]
          }
