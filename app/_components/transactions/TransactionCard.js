...
function TransactionCard({ transaction }) {
    ...
    return(
        <div className="relative not-last:border-b border-dark/20 dark:border-white/20 flex items-center">
            <div {...handlers()} onClick={!isMobile ? () => setShowMenu(true) : null} className="w-full h-full cursor-pointer px-2.5 md:px-4 py-2 flex active:bg-neutral-300/30 active:dark:bg-neutral-700/30 transition-colors duration-150 ease-in-out">
