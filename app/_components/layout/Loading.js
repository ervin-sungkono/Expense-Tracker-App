export default function Loading() {
    return(
        <div className="flex flex-col overflow-auto fixed top-0 left-0 bottom-0 right-0 bg-light dark:bg-dark">
            <main className={`relative w-full h-full max-w-3xl mx-auto flex flex-col gap-4 justify-center items-center`}>
