...
export default function SettingsList() {
  ...
  return (
    <>
      ...
      <Button
        style="danger"
        label={'Clear This Device & Sign Out'}
        onClick={() => setDeleteAccount(true)}
        className="mt-8 pb-4"
      />
      <Dialog show={showUsername} hideFn={() => setShowUsername(false)}>
      ...
      {/* <ChangeCurrencyDialog
            ...
            /> */}
      <Dialog show={showImport} hideFn={() => setShowImport(false)}>
        <ImportDataForm onFinishImport={() => setShowImport(false)} />
      </Dialog>
      <Dialog show={deleteAccount} hideFn={() => setDeleteAccount(false)} hideCancelButton>
